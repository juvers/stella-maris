  ...
  return (
    <Fragment>
      <div className="blog-details-top">
        <p>The four houses are named after the following Saints of the church:</p>
      ...
      <div className="blog-details-top">
        <div className="blog-details-img">
          <img
            alt=""
            src={process.env.PUBLIC_URL + "/assets/img/saints/stmariagoretti.png"}
          />
